...
class Fancy_Facebook_Comments_Shortcodes {
	...
	public function facebook_comments_shortcode( $params ) {
		...
		if ( ! $dont_load_sdk ) {
			$html .= '<script type="text/javascript">!function(e,n,t){var o,c=e.getElementsByTagName(n)[0];e.getElementById(t)||(o=e.createElement(n),o.id=t,o.src="//connect.facebook.net/' . esc_js( $language ) . '/sdk.js#xfbml=1&version=v22.0",c.parentNode.insertBefore(o,c))}(document,"script","facebook-jssdk");</script>';
		}
