...
<div class="metabox-holder columns-2" id="post-body">
		...
		<div class="menu_div" id="tabs">
			...
			<div class="menu_containt_div" id="tabs-1">
				...
				<div class="stuffbox">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						...
						<tr>
							<th>
							<label for="heateor_ffc_theme"><?php _e( "Theme", 'fancy-facebook-comments' ); ?></label>
							<img id="heateor_ffc_theme_help" class="heateor_ffc_help_bubble" src="<?php echo plugins_url( '../../images/info.png', __FILE__ ) ?>" />
							</th>
							<td>
							<select id="heateor_ffc_theme" name="heateor_ffc[theme]">
								<option value="light" <?php echo $options['theme'] == 'light' ? 'selected="selected"' : '' ?>><?php _e( 'Light', 'fancy-facebook-comments' ) ?></option>
								<option value="dark" <?php echo $options['theme'] == 'dark' ? 'selected="selected"' : '' ?>><?php _e( 'Dark', 'fancy-facebook-comments' ) ?></option>
							</select>
							</td>
						</tr>
						
						<tr class="heateor_ffc_help_content" id="heateor_ffc_theme_help_cont">
							<td colspan="2">
							<div>
							<?php _e( 'Choose Dark if your webpage has a dark background', 'fancy-facebook-comments' ) ?>
							</div>
							</td>
						</tr>
						...
						<tr>
							...
							if ( count( $post_types ) > 0 ) {
								foreach ( $post_types as $post_type ) {
									...
									<label for="heateor_ffc_comments_<?php echo $post_type ?>"><?php echo ucfirst( $post_type ); ?></label><br/>
									<?php
								}
							}
							?>
						...
						<tr>
							<th>
							<label for="heateor_ffc_restrict_comments"><?php _e( "Show Facebook Comments only to the logged in users", 'fancy-facebook-comments' ) ?> (<a href="https://www.heateor.com/fancy-facebook-comments-pro/" target="_blank"><?php _e( "Unlock", 'fancy-facebook-comments' ); ?></a>)</label>
							<img id="heateor_ffc_restrict_comments_help" class="heateor_ffc_help_bubble" src="<?php echo plugins_url( '../../images/info.png', __FILE__ ) ?>">
							</th>
							<td>
							<input id="heateor_ffc_restrict_comments" name="heateor_ffc[restrict_comments]" disabled type="checkbox" value="1" />
							</td>
						</tr>

						<tr class="heateor_ffc_help_content" id="heateor_ffc_restrict_comments_help_cont">
							<td colspan="2">
							<div>
							<?php _e( 'Show Facebook Comments box only to the users who are logged into your website', 'fancy-facebook-comments' ) ?>
							</div>
							</td>
						</tr>
				...
				<div class="stuffbox">
					<h3><label><?php _e( 'Export/Import configuration', 'fancy-facebook-comments' );?> (<a href="https://www.heateor.com/fancy-facebook-comments-pro/" target="_blank"><?php _e( "Unlock", 'fancy-facebook-comments' ); ?></a>)</label></h3>
					<div class="inside">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						<tr>
							<td colspan="2">
							<input type="button" class="button-primary" value="<?php _e( "Export Configuration", 'fancy-facebook-comments' ); ?>" />
							<img id="heateor_ffc_export_config_help" class="heateor_ffc_help_bubble" src="<?php echo plugins_url( '../../images/info.png', __FILE__ ) ?>" />
							</td>
						</tr>
						
						<tr class="heateor_ffc_help_content" id="heateor_ffc_export_config_help_cont">
							<td colspan="2">
							<div>
							<?php _e( 'Click this button to get the configuration of plugin at this website in the textbox below to export to some other website', 'fancy-facebook-comments' ) ?>
							</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
							<textarea id="heateor_ffc_exported_config" rows="5" cols="50" disabled></textarea>
							</td>
						</tr>

						<tr>
							<th colspan="2">
							<?php _e( "Import Configuration", 'fancy-facebook-comments' ); ?>
							<img id="heateor_ffc_import_config_help" class="heateor_ffc_help_bubble" src="<?php echo plugins_url( '../../images/info.png', __FILE__ ) ?>" />
							</th>
						</tr>
						
						<tr class="heateor_ffc_help_content" id="heateor_ffc_import_config_help_cont">
							<td colspan="2">
							<div>
							<?php _e( 'Paste the plugin-configuration you want to import to this website in the textbox given below and click Import Configuration button', 'fancy-facebook-comments' ) ?>
							</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
							<textarea id="heateor_ffc_import_config_txt" rows="5" cols="50" disabled></textarea>
							<br/>
							<input type="button" class="button-primary" value="<?php _e( "Import Configuration", 'fancy-facebook-comments' ); ?>" />
							</td>
						</tr>
					</table>
					</div>
			...
			<div class="menu_containt_div" id="tabs-2">
				<div class="clear"></div>
				<div class="heateor_ffc_left_column">
					<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank"><img style="width:83%" src="<?php echo plugins_url( '../../images/snaps/Fancy Facebook Comments - Moderation.png', __FILE__ ) ?>" /></a>
				</div>
				<?php include 'fancy-facebook-comments-about.php'; ?>
			</div>
			...
			<div class="menu_containt_div" id="tabs-3">
				<div class="clear"></div>
				<div class="heateor_ffc_left_column">
					<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank"><img style="width:99%" src="<?php echo plugins_url( '../../images/snaps/Fancy Facebook Comments - Notification.png', __FILE__ ) ?>" /></a>
				</div>
				<?php include 'fancy-facebook-comments-about.php'; ?>
			</div>
			...
			<div class="menu_containt_div" id="tabs-4">
				<div class="clear"></div>
				<div class="heateor_ffc_left_column">
					<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank"><img style="width:100%" src="<?php echo plugins_url( '../../images/snaps/Fancy Facebook Comments - GDPR.png', __FILE__ ) ?>" /></a>
				</div>
				<?php include 'fancy-facebook-comments-about.php'; ?>
			</div>
			...
			<div class="menu_containt_div" id="tabs-5">
				<div class="clear"></div>
				<div class="heateor_ffc_left_column">
					<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank"><img style="width:100%" src="<?php echo plugins_url( '../../images/snaps/Fancy Facebook Comments - mycred.png', __FILE__ ) ?>" /></a>
				</div>
				<?php include 'fancy-facebook-comments-about.php'; ?>
			</div>
			...
			<div class="menu_containt_div" id="tabs-8">
				...
				<div class="stuffbox">
					...
					<div class="inside faq">
						<div class="inside" style="padding-left:7px">
							<p><a style="text-decoration:none" href="https://www.heateor.com/fancy-facebook-comments-pro/" target="_blank"><?php _e( 'How to get notified for Facebook Comments being posted at the website and moderate these?', 'fancy-facebook-comments' ) ?></a></p>
